...
<head>
    ...
    <title>خدمات فوتبالی | لیست باشگاه های فوتبال</title>
    ...
    <section class="container-fluid">
        <header class="row">
            ...
            <section class="col-12">
                <h1 class="text-center text-primary m-0 p-5">لیست باشگاه های فوتبال</h1>
            </section>
        </header>
            ...
            <section class="col-12">
                ...
                if (isset($alert)) {
                    ...
                    foreach ($table as $row) {
                        include __DIR__ . '/templates/football_club_card.php';
                    }
                }
                ?>
            </section>
